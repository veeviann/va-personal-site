...
| **fracdiff**   | Implements fractionally differenced ARIMA models for time series.               |
| **geofacet**   | Creates geofaceted visualizations for spatial data.                             |
| **GGally**     | Enhances ggplot2 with extensions like pairwise plots (GGpairs).                 |
...
| **glue**       | Provides an easy way to interpolate and manipulate strings.                     |
| **knitr**      | Facilitates dynamic report generation, especially with R Markdown.              |
...
| **urca**       | Performs unit root and cointegration tests for time series analysis.            |
...
## 4.1 Data Processing & Exploration
...
```{r}
#| code-fold: true
#| code-summary: "Showing the top 10 imports"
#
...
```{r}
#| code-fold: true
#| code-summary: "Showing the top 10 domestic exports"
...
```{r}
#| code-fold: true
#| code-summary: "Showing the top 10 re-exports"
...
```{r}
#| code-fold: true
#| code-summary: "Data processing - by region"
...
```{r}
#| code-fold: true
#| code-summary: "Top merchandise trade by region"
...
## 4.2 Time Series Patterns - By Trade Regions
...
```{r}
#| code-fold: true
#| code-summary: "Plot time series using ggplot"
#| fig-height: 6
#| fig-width: 12
...
```{r}
#| code-fold: true
#| code-summary: "Checking by import category division"
#| fig-height: 5
#| fig-width: 16
...
```{r}
#| code-fold: true
#| code-summary: "seasonality plots"
#| fig-height: 12
#| fig-width: 8
...
```{r}
#| code-fold: true
#| code-summary: "seasonality subseries"
...
```{r}
#| code-fold: true
#| code-summary: "scatter pairplots"
