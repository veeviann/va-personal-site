...
A summary table detailing the purpose of each package (sorted alphabetically) will be provided.
...
The table above compares the odds ratio and its confidence interval for the factors, when modelled univariately and when modelled as a multivariate model. We can see that the odds ratio do not differ when modeled together.. then?
